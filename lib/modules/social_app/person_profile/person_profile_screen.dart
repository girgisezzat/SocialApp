...
class PersonProfileScreen extends StatelessWidget {
  ...
  final personId;
  const PersonProfileScreen({this.personId});
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
        builder: (BuildContext context) {
          ...
          SocialCubit.get(context).getAllPersonData(
              personId:personId,
          );
          SocialCubit.get(context).getPersonData(
            personId:personId,
          );
          SocialCubit.get(context).getPersonPosts(
            personId:personId,
          );
          ...
          return BlocConsumer<SocialCubit,SocialState>(
            ...
            builder: (context,state){
              ...
              var personModel = SocialCubit.get(context).personModel;

              return Padding(
                padding: const EdgeInsets.all(8.0),
                child: Conditional.single(
                  context: context,
                  conditionBuilder:(context)=> SocialCubit.get(context).personPosts.length > 0
                      && SocialCubit.get(context).personModel !=null,
                      ...
                      [
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) =>
                              buildPersonPostItem(SocialCubit.get(context).personPosts[index],context,index),
  ...
  Widget buildPersonPostItem(PostModel model,context,index) => Card(
            ...
            children: [
              ...
              PopupMenuButton(
                ...
                onSelected: (choice){
                  switch(choice){
                    case 'delete':
                      SocialCubit.get(context).deletePost(SocialCubit.get(context).personPostsId[index]);
                      break;
                  }
                },
              ),
